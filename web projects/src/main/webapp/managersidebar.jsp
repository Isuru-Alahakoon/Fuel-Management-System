...
<head>
<meta charset="UTF-8">
<title>Manager Sidebar | Sri Drive</title>
<style>
    :root {
        --primary: #4361ee;
        --primary-dark: #3a56d4;
...
<body>
    ...
    <div class="sidebar">
        <ul>
            <li class="active"><a href="managerDashboard.jsp"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
            <li><a href="manager_get_fuelStock"><i class="fas fa-gas-pump"></i> <span>Fuel Stock</span></a></li>
            <li><a href="#"><i class="fas fa-tools"></i> <span>Service Management</span></a></li>
            <li><a href="manager_attendant_management"><i class="fas fa-users"></i> <span>Attendants</span></a></li>
            <li><a href="#"><i class="fas fa-receipt"></i> <span>Transactions</span></a></li>
            <li><a href="manager_get_station"><i class="fas fa-store"></i> <span>My Stations</span></a></li>
